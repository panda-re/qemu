...
QPP_FUN_PROTOTYPE2(osi, OsiProc*, get_current_process, void);
QPP_FUN_PROTOTYPE2(osi, OsiProc*, get_process, const OsiProcHandle*);
QPP_FUN_PROTOTYPE2(osi, OsiProcHandle*, get_current_process_handle, void);
