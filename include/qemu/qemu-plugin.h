...
enum qemu_plugin_mem_rw {
    ...
    QEMU_PLUGIN_BEFORE_MEM = 0x10,
    QEMU_PLUGIN_AFTER_MEM = 0x20,
    QEMU_PLUGIN_BEFORE_MEM_R  = QEMU_PLUGIN_BEFORE_MEM | QEMU_PLUGIN_MEM_R,
    QEMU_PLUGIN_BEFORE_MEM_W  = QEMU_PLUGIN_BEFORE_MEM | QEMU_PLUGIN_MEM_W,
    QEMU_PLUGIN_BEFORE_MEM_RW = QEMU_PLUGIN_BEFORE_MEM | QEMU_PLUGIN_MEM_RW,
    QEMU_PLUGIN_AFTER_MEM_R  = QEMU_PLUGIN_AFTER_MEM | QEMU_PLUGIN_MEM_R,
    QEMU_PLUGIN_AFTER_MEM_W  = QEMU_PLUGIN_AFTER_MEM | QEMU_PLUGIN_MEM_W,
    QEMU_PLUGIN_AFTER_MEM_RW = QEMU_PLUGIN_AFTER_MEM | QEMU_PLUGIN_MEM_RW,
};
